...
export const LIBRARY: Rubrique[] = [
  {
    ...
    templates: [
      ...
      { title: 'Inbox zéro avant de partir', kind: 'timed', before: '18:00', difficulty: 'hard', days: [1, 2, 3, 4, 5] },
      { title: 'Aider un collègue en difficulté', kind: 'daily', difficulty: 'normal', days: [2, 4] },
      { title: 'Apprendre un raccourci / outil qui fait gagner du temps', kind: 'daily', difficulty: 'easy', days: [3] },
      { title: 'Proposer une idée en réunion', kind: 'quest', difficulty: 'hard' },
      { title: 'Décrocher un nouveau client / projet', kind: 'quest', difficulty: 'epic' },
    ],
  },
  {
    id: 'etudes',
  ...
  },
  {
    ...
    templates: [
      ...
      { title: 'Atteindre son objectif de pas', kind: 'daily', difficulty: 'normal' },
      { title: '50 squats', kind: 'daily', difficulty: 'normal' },
      { title: 'Séance d’étirements du soir', kind: 'timed', before: '22:30', difficulty: 'easy' },
      { title: 'Une semaine sans manquer une séance', kind: 'quest', difficulty: 'epic' },
    ],
  },
  {
    id: 'nutrition',
  ...
  },
  {
    ...
    templates: [
      ...
      { title: 'Zéro réseau social pendant le travail', kind: 'daily', difficulty: 'hard', days: [1, 2, 3, 4, 5] },
      { title: 'Refactorer un vieux bout de code', kind: 'daily', difficulty: 'normal', days: [5] },
      { title: 'Écrire un test de plus', kind: 'daily', difficulty: 'easy', days: [1, 3] },
      { title: 'Automatiser une corvée récurrente', kind: 'quest', difficulty: 'hard' },
    ],
  },
  {
    id: 'amour',
    ...
    icon: 'heart',
    desc: 'Couple, attentions, complicité',
    templates: [
      { title: 'Envoyer un message attentionné', kind: 'daily', difficulty: 'easy' },
      { title: 'Un vrai moment à deux sans écran', kind: 'daily', difficulty: 'normal' },
      { title: 'Dire ce que j’apprécie chez l’autre', kind: 'daily', difficulty: 'easy', days: [0, 3] },
      { title: 'Demander comment s’est passée sa journée (et écouter)', kind: 'daily', difficulty: 'easy' },
      { title: 'Préparer le café / thé de l’autre avant 8h', kind: 'timed', before: '08:00', difficulty: 'easy' },
      { title: 'Un compliment sincère avant 22h', kind: 'timed', before: '22:00', difficulty: 'easy' },
      { title: 'Organiser un rendez-vous surprise', kind: 'quest', difficulty: 'normal' },
      { title: 'Planifier une soirée en amoureux', kind: 'quest', difficulty: 'normal' },
      { title: 'Offrir un cadeau sans occasion', kind: 'quest', difficulty: 'normal' },
      { title: 'Avoir LA conversation qu’on repousse', kind: 'quest', difficulty: 'hard' },
      { title: 'Préparer une escapade en week-end', kind: 'quest', difficulty: 'hard' },
      { title: 'Écrire une lettre d’amour à l’ancienne', kind: 'quest', difficulty: 'epic' },
    ],
  },
  {
    id: 'spiritualite',
    name: 'Spiritualité',
    icon: 'sparkle',
    desc: 'Prière, foi, élévation intérieure',
    templates: [
      { title: 'Prière / recueillement du matin', kind: 'timed', before: '08:00', difficulty: 'easy' },
      { title: 'Prière / recueillement du soir', kind: 'timed', before: '23:00', difficulty: 'easy' },
      { title: 'Lecture spirituelle (15 min)', kind: 'daily', difficulty: 'easy' },
      { title: 'Un acte de bonté anonyme', kind: 'daily', difficulty: 'normal' },
      { title: 'Moment de silence total (10 min)', kind: 'daily', difficulty: 'normal' },
      { title: 'Pardonner une offense du jour', kind: 'daily', difficulty: 'hard' },
      { title: 'Assister à un office / une assemblée', kind: 'daily', difficulty: 'normal', days: [0] },
      { title: 'Jeûner une journée', kind: 'quest', difficulty: 'hard' },
      { title: 'Faire un don ou aider un inconnu', kind: 'quest', difficulty: 'normal' },
      { title: 'Une retraite d’une journée entière', kind: 'quest', difficulty: 'epic' },
    ],
  },
  {
    id: 'animaux',
    name: 'Animaux',
    icon: 'seed',
    desc: 'Compagnons à poils, plumes ou écailles',
    templates: [
      { title: 'Promenade du chien (matin)', kind: 'timed', before: '09:00', difficulty: 'easy' },
      { title: 'Promenade du chien (soir)', kind: 'timed', before: '21:00', difficulty: 'easy' },
      { title: 'Nourrir et changer l’eau', kind: 'daily', difficulty: 'easy' },
      { title: 'Séance de jeu (15 min)', kind: 'daily', difficulty: 'easy' },
      { title: 'Brossage / toilettage', kind: 'daily', difficulty: 'easy', days: [3, 6] },
      { title: 'Nettoyer la litière / la cage', kind: 'daily', difficulty: 'normal', days: [1, 4] },
      { title: 'Apprendre un nouveau tour', kind: 'quest', difficulty: 'normal' },
      { title: 'Visite vétérinaire annuelle', kind: 'quest', difficulty: 'normal' },
      { title: 'Grand nettoyage de son espace', kind: 'quest', difficulty: 'hard' },
    ],
  },
  {
    id: 'sorties',
    name: 'Sorties & Aventure',
    icon: 'map',
    desc: 'Explorer, découvrir, respirer dehors',
    templates: [
      { title: 'Sortir prendre l’air (20 min)', kind: 'daily', difficulty: 'easy' },
      { title: 'Prendre le soleil avant midi', kind: 'timed', before: '12:00', difficulty: 'easy' },
      { title: 'Découvrir une rue / un endroit inconnu', kind: 'daily', difficulty: 'normal', days: [6, 0] },
      { title: 'Photographier un endroit nouveau', kind: 'daily', difficulty: 'easy', days: [6] },
      { title: 'Visiter un musée ou une expo', kind: 'quest', difficulty: 'normal' },
      { title: 'Randonnée d’une demi-journée', kind: 'quest', difficulty: 'hard' },
      { title: 'Partir en excursion dans une autre ville', kind: 'quest', difficulty: 'hard' },
      { title: 'Regarder un lever de soleil', kind: 'quest', difficulty: 'hard' },
      { title: 'Nuit à la belle étoile', kind: 'quest', difficulty: 'epic' },
      { title: 'Voyage dans un pays jamais visité', kind: 'quest', difficulty: 'epic' },
    ],
  },
  {
    id: 'admin',
    name: 'Administratif',
    icon: 'list',
    desc: 'Paperasse, démarches, dossiers',
    templates: [
      { title: 'Traiter le courrier du jour', kind: 'daily', difficulty: 'easy', days: [1, 2, 3, 4, 5] },
      { title: 'Classer les documents de la semaine', kind: 'daily', difficulty: 'easy', days: [5] },
      { title: 'Scanner les papiers importants', kind: 'daily', difficulty: 'normal', days: [0] },
      { title: 'Renouveler une pièce d’identité', kind: 'quest', difficulty: 'normal' },
      { title: 'Prendre le rendez-vous médical repoussé', kind: 'quest', difficulty: 'normal' },
      { title: 'Mettre à jour ses contrats (assurance, banque…)', kind: 'quest', difficulty: 'hard' },
      { title: 'Régler le litige en attente', kind: 'quest', difficulty: 'hard' },
      { title: 'Zéro papier en retard : tout traiter', kind: 'quest', difficulty: 'epic' },
    ],
  },
  {
    id: 'style',
    name: 'Style & Image',
    icon: 'user',
    desc: 'Allure, garde-robe, présence',
    templates: [
      { title: 'Tenue impeccable avant de sortir', kind: 'timed', before: '09:00', difficulty: 'easy', days: [1, 2, 3, 4, 5] },
      { title: 'Chaussures propres', kind: 'daily', difficulty: 'easy', days: [1, 4] },
      { title: 'Repasser les tenues de la semaine', kind: 'daily', difficulty: 'normal', days: [0] },
      { title: 'Trier la garde-robe (donner le surplus)', kind: 'quest', difficulty: 'normal' },
      { title: 'Renouveler une pièce maîtresse', kind: 'quest', difficulty: 'normal' },
      { title: 'Soigner sa posture toute la journée', kind: 'daily', difficulty: 'hard' },
      { title: 'Refonte complète du style', kind: 'quest', difficulty: 'epic' },
    ],
  },
  {
    id: 'sommeil',
